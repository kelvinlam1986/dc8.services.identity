...
using Dc8.Services.Identity.Application.Events;
using Dc8.Services.Identity.Core.Entities;
using Dc8.Services.Identity.Core.Exceptions;
using Dc8.Services.Identity.Core.Repositories;
...
namespace Dc8.Services.Identity.Application.Services.Identity
{
